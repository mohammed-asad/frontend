...
<div class="other-container">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 m-auto p-xl-0">
					<h2 class="text-center head1 wow fadeInDown">Upcoming Tours</h2>
	...
	<section class="text-center section">
		<div class="contianer">
			<!-- Section heading -->
			<h2 class="h1-responsive font-weight-bold text-center head1 wow fadeInDown">Introducing Travel Private</h2>
