...
<body>
  ...
  <div class="ruby-menu-demo-header">
    ...
    <div class="ruby-wrapper">
      ...
      <ul class="ruby-menu">
        <li class="ruby-menu-mega"><a href="#">Travel Private</a></li>
        <li class="ruby-menu-mega-blog"><a href="#">Destinations</a>
          <div style="height: 269.359px;" class="">
            <ul class="ruby-menu-mega-blog-nav">
              <li class="ruby-active-menu-item mb-3"><a href="#">Europe</a>
                <div class="ruby-grid ruby-grid-lined" style="height: 264.359px;">
                  <div class="container">
                    <div class="row">
                      <div class="col-lg-3 col-md-3">
                        <h4>Overviews</h4>
                        <span class="ruby-c-content text-left">Europe is a continent located entirely in the Northern Hemisphere and mostly in the Eastern Hemisphere.
                          It is bordered by the Arctic Ocean to the north, the Atlantic Ocean to the west,
                          Asia to the east, and the Mediterranean Sea to the south.
                          It comprises the westernmost part of Eurasia.</span>
                      </div>
                      <div class="col-lg-2 offset-lg-1 col-md-3 text-left">
                        <h4>Destinations</h4>
                        <ul class="des">
                          <li>
                            <a href="#">France</a>
                        ...
                        <div class="wrapper-carousel-fix mega-menu-slider text-white">
                          ...
                          <div id="carousel-example-2" class="carousel no-flex testimonial-carousel" data-ride="carousel" data-interval="false">
                            ...
                            <ul class="carousel-indicators custom-indicators text-left d-inline-flex">
                              ...
                              <a class="carousel-control-prev left carousel-control" href="#carousel-example-2" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon"></span>
                              </a>
                              <a class="carousel-control-next right carousel-control" href="#carousel-example-2" role="button" data-slide="next">
        ...
        <li class="ruby-menu-mega"><a href="#">Our Specialities</a></li>
