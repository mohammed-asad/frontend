            ...
            <li>
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-8 timeline-right">
                  <div class="row">
                    <div class="col-xl-1 col-lg-2 col-md-2 pr-0 text-center-md"><i class="fa fa-bus mr-2" aria-hidden="true"></i></div>
                    <div class="col-md-11 col-lg-10 col-md-10 pl-0">
                      <p class="ml-2"> Guest will be picked from hotel and proceed for Dhow dinner cruise Dinner will be served on cruise</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-8 timeline-right">
                  <div class="row">
                    <div class="col-xl-1 col-lg-2 col-md-2 pr-0 text-center-md"><i class="fa fa-bus mr-2" aria-hidden="true"></i></div>
                    <div class="col-md-11 col-lg-10 col-md-10 pl-0">
                      <p class="ml-2"> Check in to your hotel. </p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-8 timeline-right">
                  <div class="row">
                    <div class="col-xl-1 col-lg-2 col-md-2 pr-0 text-center-md"><i class="fa fa-bus mr-2" aria-hidden="true"></i></div>
                    <div class="col-md-11 col-lg-10 col-md-10 pl-0">
                      <p class="ml-2"> Return to hotel. </p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-8 timeline-right">
                  <div class="row">
                    <div class="col-xl-1 col-lg-2 col-md-2 pr-0 text-center-md"><i class="fa fa-bus mr-2" aria-hidden="true"></i></div>
                    <div class="col-md-11 col-lg-10 col-md-10 pl-0">
                      <p class="ml-2"> Overnight stay at hotel. </p>
                    </div>
                  </div>
                </div>
              </div>
